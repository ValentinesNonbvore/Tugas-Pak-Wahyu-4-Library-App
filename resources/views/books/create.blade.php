<x-layout returnButton="/">
    ...
    <form class="space-y-6" action="/books/create" method="POST">
        @csrf
        ...
        <div>
            ...
            <label class="input input-bordered flex items-center gap-2 w-[100%] mt-2">
                ...
                <input type="text" class="grow text-lg" placeholder="Title" id="title" name="title" required />
            </label>
            @error('title')
        ...
        <div>
            ...
            <label class="input input-bordered flex items-center gap-2 w-[100%] mt-2">
                ...
                <input type="number" class="grow text-lg" placeholder="Year (1000-9999)" id="publication_year"
                    name="publication_year" min="1000" max="9999" required />
            </label>
        ...
        <div>
            ...
            <label class="input input-bordered flex items-center gap-2 w-[100%] mt-2">
                ...
                <input type="text" class="grow text-lg" placeholder="ISBN" id="isbn" name="isbn" required />
            </label>
            @error('isbn')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
